...
/**
 * ildhtmlinteract conversion handler
 */
class moodle1_mod_ildhtmlinteract_handler extends moodle1_mod_handler {

    /** @var moodle1_file_manager instance */
    protected $fileman = null;

    /** @var array of ildhtmlinteract successors handlers */
     ...
     * defined.
     *
     * Note that the paths /MOODLE_BACKUP/COURSE/MODULES/MOD/ILDHTMLINTERACT do not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'ildhtmlinteract', '/MOODLE_BACKUP/COURSE/MODULES/MOD/ILDHTMLINTERACT',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
                    ),
    ...
    /**
     * Converts /MOODLE_BACKUP/COURSE/MODULES/MOD/ILDHTMLINTERACT data
     *
