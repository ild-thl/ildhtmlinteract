 ...
 */
class backup_ildhtmlinteract_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        // Define sources
        $resource->set_source_table('ildhtmlinteract', array('id' => backup::VAR_ACTIVITYID));

        // Define id annotations
        // (none)

        // Define file annotations
        $resource->annotate_files('mod_ildhtmlinteract', 'intro', null); // This file areas haven't itemid
        $resource->annotate_files('mod_ildhtmlinteract', 'content', null); // This file areas haven't itemid
