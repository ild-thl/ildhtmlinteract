 ...
 */
class restore_ildhtmlinteract_activity_structure_step extends restore_activity_structure_step {

    protected function define_structure() {

        $paths = array();
        $paths[] = new restore_path_element('ildhtmlinteract', '/activity/ildhtmlinteract');
    ...
    protected function process_ildhtmlinteract($data) {
        ...
        $newitemid = $DB->insert_record('ildhtmlinteract', $data);
    ...
    protected function after_execute() {
        ...
        $this->add_related_files('mod_ildhtmlinteract', 'intro', null);
        $this->add_related_files('mod_ildhtmlinteract', 'content', null);
    }
}
