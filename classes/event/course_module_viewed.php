...
/**
 * The mod_ildhtmlinteract course module viewed event.
 *
...
/**
 * The mod_ildhtmlinteract course module viewed event class.
 *
...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init() {
        $this->data['objecttable'] = 'ildhtmlinteract';
        $this->data['crud'] = 'r';
        $this->data['edulevel'] = self::LEVEL_PARTICIPATING;
    }

    public static function get_objectid_mapping() {
        return array('db' => 'ildhtmlinteract', 'restore' => 'ildhtmlinteract');
    }
}
