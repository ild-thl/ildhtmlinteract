...
/**
 * Strings for component 'ildhtmlinteract', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['configparametersettings'] = 'This sets the default value for the Parameter settings pane in the form when adding some new htmlinteracts. After the first time, this becomes an individual user preference.';
$string['configpopup'] = 'When adding a new htmlinteract which is able to be shown in a popup window, should this option be enabled by default?';
...
$string['dnduploadildhtmlinteract'] = 'Create file interaction';
...
$string['filtername'] = 'htmlinteract names auto-linking';
...
* To include a mini website as a course interaction
* To provide draft files of certain software programs (eg Photoshop .psd) so students can edit and submit them for assessment';
$string['modulename_link'] = 'mod/ildhtmlinteract/view';
$string['modulenameplural'] = 'HTML5 Interaction';
$string['notmigrated'] = 'This legacy resource type ({$a}) was not yet migrated, sorry.';
$string['optionsheader'] = 'Display options';
$string['page-mod-ildhtmlinteract-x'] = 'Any file module page';
$string['pluginadministration'] = 'File module administration';
$string['pluginname'] = 'HTML5 Interaction';
$string['frameheight'] = 'iframe height (in pixels)';
$string['popupheightexplain'] = 'Specifies default height of the iframe.';
$string['popupresource'] = 'This interaction should appear in a popup window.';
$string['popupresourcelink'] = 'If it didn\'t, click here: {$a}';
$string['framewidth'] = 'iframe width (in pixels)';
$string['popupwidthexplain'] = 'Specifies default width of the iframe.';
$string['printintro'] = 'Display interaction description';
$string['printintroexplain'] = 'Display interaction description below content? Some display types may not display description even if enabled.';
$string['privacy:metadata'] = 'The File interaction plugin does not store any personal data.';
$string['ildhtmlinteract:addinstance'] = 'Add a new HTML5 interaction';
$string['ildhtmlinteractcontent'] = 'Files and subfolders';
$string['ildhtmlinteractdetails_sizetype'] = '{$a->size} {$a->type}';
$string['ildhtmlinteractdetails_sizedate'] = '{$a->size} {$a->date}';
$string['ildhtmlinteractdetails_typedate'] = '{$a->type} {$a->date}';
$string['ildhtmlinteractdetails_sizetypedate'] = '{$a->size} {$a->type} {$a->date}';
$string['ildhtmlinteract:exportildhtmlinteract'] = 'Export interaction';
$string['ildhtmlinteract:view'] = 'View interaction';
$string['search:activity'] = 'HTML5 Interaction';
...
If there are multiple files in this interaction, the start file upload/modified date is displayed.';
$string['showsize'] = 'Show size';
$string['showsize_help'] = 'Displays the file size, such as \'3.1 MB\', beside links to the file.

If there are multiple files in this interaction, the total size of all files is displayed.';
...
If there are multiple files in this interaction, the start file type is displayed.
